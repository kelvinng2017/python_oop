...
class Banks():
    ...
    def bank_title(self):  # get bank name
...
class Shilin_Banks(Banks):
    ...
    def __init__(self, uname):
        self.bankname = "Taipei Bank - Shilin Branch"  # Define branch name

    def bank_title(self):  # get bank name
        return self.bankname


jamesbank = Banks("James")  # Define Bank class object
print("James's bank = ", jamesbank.bank_title())  # print bank name
hungbank = Shilin_Banks('hung')  # define shilin_Banks class object
print("Hung's bank = ", hungbank.bank_title())  # print bank name
